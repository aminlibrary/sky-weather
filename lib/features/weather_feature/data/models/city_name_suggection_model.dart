...
class CityNameSuggectionModel extends CityNameSuggectionEntity {
  const CityNameSuggectionModel({
    super.data,
    super.metadata,
  });

  factory CityNameSuggectionModel.fromJson(dynamic json) {
    ...
    return CityNameSuggectionModel(
      data: data,
      metadata:
